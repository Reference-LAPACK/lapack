...
/* Refill the inputs, schedule the malloc failure, call cgetri. */
...
LAPACKE_TEST(cgetri)
{
    ...
    LAPACKE_CGETRI_ALLOC_TEST(0, 0, "cgetri work alloc failure (work)",
    ...
    LAPACKE_CGETRI_ALLOC_TEST(1, 0, "cgetri work alloc failure (work)",
                              LAPACK_WORK_MEMORY_ERROR);
    LAPACKE_CGETRI_ALLOC_TEST(1, 1, "cgetri transpose alloc failure (a_t)",
