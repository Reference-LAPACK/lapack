...
#define LAPACKE_CGETRI_ALLOC_TEST(layout_index, countdown, name, expected)     \
    do {                                                                       \
        ...
        lapacke_test_check(name, lapacke_test_layout_names[layout_index],      \
                           LAPACKE_cgetri(layout, N, a, LD, ipiv), expected);  \
    } while (0)
...
LAPACKE_TEST(cgetri)
{
    ...
    for (size_t l = 0; l < 2; l++) {
        ...
        LAPACKE_TEST_CNAN_SWEEP("cgetri a", l, N, N, a, LD,
                                lapacke_test_region_full, -3,
                                (lapacke_test_cfill(layout, N, N, a, LD)),
                                LAPACKE_cgetri(layout, N, a, LD, ipiv));
        ...
        lapacke_test_check(
            ...
            LAPACKE_cgetri(layout, N, a, LD, ipiv) >= 0 ? 0 : -999, 0);
    ...
    LAPACKE_CGETRI_ALLOC_TEST(1, 2, "cgetri recovers after alloc failure", 0);
    lapacke_test_check_alloc_count("cgetri allocation count");
