...
/* Refill the inputs, schedule the malloc failure, call dgetri. */
...
LAPACKE_TEST(dgetri)
{
    ...
    LAPACKE_DGETRI_ALLOC_TEST(0, 0, "dgetri work alloc failure (work)",
    ...
    LAPACKE_DGETRI_ALLOC_TEST(1, 0, "dgetri work alloc failure (work)",
                              LAPACK_WORK_MEMORY_ERROR);
    LAPACKE_DGETRI_ALLOC_TEST(1, 1, "dgetri transpose alloc failure (a_t)",
