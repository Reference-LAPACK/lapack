...
#define LAPACKE_CGETRF_ALLOC_TEST(layout_index, countdown, name, expected)     \
    do {                                                                       \
        ...
        lapacke_test_check(name, lapacke_test_layout_names[layout_index],      \
                           LAPACKE_cgetrf(layout, M, N, a, LD, ipiv),          \
                           expected);                                          \
    } while (0)
...
LAPACKE_TEST(cgetrf)
{
    ...
    for (size_t l = 0; l < 2; l++) {
        ...
        LAPACKE_TEST_CNAN_SWEEP("cgetrf a", l, M, N, a, LD,
        ...
        lapacke_test_check(
            ...
            LAPACKE_cgetrf(layout, M, N, a, LD, ipiv) >= 0 ? 0 : -999, 0);
    ...
    LAPACKE_CGETRF_ALLOC_TEST(1, 1, "cgetrf recovers after alloc failure", 0);
    lapacke_test_check_alloc_count("cgetrf allocation count");
