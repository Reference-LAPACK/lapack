...
#define LAPACKE_CGEQRF_ALLOC_TEST(layout_index, countdown, name, expected)     \
    do {                                                                       \
        ...
        lapacke_test_check(name, lapacke_test_layout_names[layout_index],      \
                           LAPACKE_cgeqrf(layout, M, N, a, LD, tau),           \
                           expected);                                          \
    } while (0)
...
LAPACKE_TEST(cgeqrf)
{
    ...
    for (size_t l = 0; l < 2; l++) {
        ...
        LAPACKE_TEST_CNAN_SWEEP("cgeqrf a", l, M, N, a, LD,
        ...
        lapacke_test_check(
            ...
            LAPACKE_cgeqrf(layout, M, N, a, LD, tau) >= 0 ? 0 : -999, 0);
    ...
    LAPACKE_CGEQRF_ALLOC_TEST(1, 2, "cgeqrf recovers after alloc failure", 0);
    lapacke_test_check_alloc_count("cgeqrf allocation count");
