...
/* Refill the inputs, schedule the malloc failure, call cgeqrf. */
...
LAPACKE_TEST(cgeqrf)
{
    ...
    LAPACKE_CGEQRF_ALLOC_TEST(0, 0, "cgeqrf work alloc failure (work)",
    ...
    LAPACKE_CGEQRF_ALLOC_TEST(1, 0, "cgeqrf work alloc failure (work)",
                              LAPACK_WORK_MEMORY_ERROR);
    LAPACKE_CGEQRF_ALLOC_TEST(1, 1, "cgeqrf transpose alloc failure (a_t)",
