...
/* Refill the inputs, schedule the malloc failure, call zgetri. */
...
LAPACKE_TEST(zgetri)
{
    ...
    LAPACKE_ZGETRI_ALLOC_TEST(0, 0, "zgetri work alloc failure (work)",
    ...
    LAPACKE_ZGETRI_ALLOC_TEST(1, 0, "zgetri work alloc failure (work)",
                              LAPACK_WORK_MEMORY_ERROR);
    LAPACKE_ZGETRI_ALLOC_TEST(1, 1, "zgetri transpose alloc failure (a_t)",
