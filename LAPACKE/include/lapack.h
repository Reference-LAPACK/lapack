...
#define LAPACK_dktebz_base LAPACK_GLOBAL_SUFFIX(dktebz,DKTEBZ)
void LAPACK_dktebz_base(
    char const* range, char const* order,
    lapack_int const* n,
    double const* vl,
    double const* vu, lapack_int const* il, lapack_int const* iu,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dktebz(...) LAPACK_dktebz_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_dktebz(...) LAPACK_dktebz_base(__VA_ARGS__)
#endif

#define LAPACK_sktebz_base LAPACK_GLOBAL_SUFFIX(sktebz,SKTEBZ)
void LAPACK_sktebz_base(
    char const* range, char const* order,
    lapack_int const* n,
    float const* vl,
    float const* vu, lapack_int const* il, lapack_int const* iu,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_sktebz(...) LAPACK_sktebz_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_sktebz(...) LAPACK_sktebz_base(__VA_ARGS__)
#endif
...
#define LAPACK_dktedc_base LAPACK_GLOBAL_SUFFIX(dktedc,DKTEDC)
void LAPACK_dktedc_base(
    char const* compz,
    lapack_int const* n,
    double* E,
    double* Z, lapack_int const* ldz,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dktedc(...) LAPACK_dktedc_base(__VA_ARGS__, 1)
#else
    #define LAPACK_dktedc(...) LAPACK_dktedc_base(__VA_ARGS__)
#endif

#define LAPACK_sktedc_base LAPACK_GLOBAL_SUFFIX(sktedc,SKTEDC)
void LAPACK_sktedc_base(
    char const* compz,
    lapack_int const* n,
    float* E,
    float* Z, lapack_int const* ldz,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_sktedc(...) LAPACK_sktedc_base(__VA_ARGS__, 1)
#else
    #define LAPACK_sktedc(...) LAPACK_sktedc_base(__VA_ARGS__)
#endif
...
#define LAPACK_dktein LAPACK_GLOBAL_SUFFIX(dktein,DKTEIN)
void LAPACK_dktein(
    lapack_int const* n,
    double const* E, lapack_int const* m,
    double const* W, lapack_int const* IBLOCK, lapack_int const* ISPLIT,
...
#define LAPACK_sktein LAPACK_GLOBAL_SUFFIX(sktein,SKTEIN)
void LAPACK_sktein(
    lapack_int const* n,
    float const* E, lapack_int const* m,
    float const* W, lapack_int const* IBLOCK, lapack_int const* ISPLIT,
...
#define LAPACK_dktevd_base LAPACK_GLOBAL_SUFFIX(dktevd,DKTEVD)
void LAPACK_dktevd_base(
    char const* jobz,
    lapack_int const* n,
    double* D,
    double* E,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dktevd(...) LAPACK_dktevd_base(__VA_ARGS__, 1)
#else
    #define LAPACK_dktevd(...) LAPACK_dktevd_base(__VA_ARGS__)
#endif

#define LAPACK_sktevd_base LAPACK_GLOBAL_SUFFIX(sktevd,SKTEVD)
void LAPACK_sktevd_base(
    char const* jobz,
    lapack_int const* n,
    float* D,
    float* E,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_sktevd(...) LAPACK_sktevd_base(__VA_ARGS__, 1)
#else
    #define LAPACK_sktevd(...) LAPACK_sktevd_base(__VA_ARGS__)
#endif
...
#define LAPACK_dktevx_base LAPACK_GLOBAL_SUFFIX(dktevx,DKTEVX)
void LAPACK_dktevx_base(
    char const* jobz, char const* range,
    lapack_int const* n,
    double* E,
    double const* vl,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dktevx(...) LAPACK_dktevx_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_dktevx(...) LAPACK_dktevx_base(__VA_ARGS__)
#endif

#define LAPACK_sktevx_base LAPACK_GLOBAL_SUFFIX(sktevx,SKTEVX)
void LAPACK_sktevx_base(
    char const* jobz, char const* range,
    lapack_int const* n,
    float* E,
    float const* vl,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_sktevx(...) LAPACK_sktevx_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_sktevx(...) LAPACK_sktevx_base(__VA_ARGS__)
#endif
...
#define LAPACK_dkyevd_base LAPACK_GLOBAL_SUFFIX(dkyevd,DKYEVD)
void LAPACK_dkyevd_base(
    char const* jobz, char const* uplo,
    lapack_int const* n,
    double* A, lapack_int const* lda,
    double* W,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dkyevd(...) LAPACK_dkyevd_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_dkyevd(...) LAPACK_dkyevd_base(__VA_ARGS__)
#endif

#define LAPACK_skyevd_base LAPACK_GLOBAL_SUFFIX(skyevd,SKYEVD)
void LAPACK_skyevd_base(
    char const* jobz, char const* uplo,
    lapack_int const* n,
    float* A, lapack_int const* lda,
    float* W,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_skyevd(...) LAPACK_skyevd_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_skyevd(...) LAPACK_skyevd_base(__VA_ARGS__)
#endif
...
#define LAPACK_dkyevx_base LAPACK_GLOBAL_SUFFIX(dkyevx,DKYEVX)
void LAPACK_dkyevx_base(
    char const* jobz, char const* range, char const* uplo,
    lapack_int const* n,
    double* A, lapack_int const* lda,
    double const* vl,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dkyevx(...) LAPACK_dkyevx_base(__VA_ARGS__, 1, 1, 1)
#else
    #define LAPACK_dkyevx(...) LAPACK_dkyevx_base(__VA_ARGS__)
#endif

#define LAPACK_skyevx_base LAPACK_GLOBAL_SUFFIX(skyevx,SKYEVX)
void LAPACK_skyevx_base(
    char const* jobz, char const* range, char const* uplo,
    lapack_int const* n,
    float* A, lapack_int const* lda,
    float const* vl,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_skyevx(...) LAPACK_skyevx_base(__VA_ARGS__, 1, 1, 1)
#else
    #define LAPACK_skyevx(...) LAPACK_skyevx_base(__VA_ARGS__)
#endif
...
#define LAPACK_dkygvd_base LAPACK_GLOBAL_SUFFIX(dkygvd,DKYGVD)
void LAPACK_dkygvd_base(
    lapack_int const* itype, char const* jobz, char const* uplo,
    lapack_int const* n,
    double* A, lapack_int const* lda,
    double* B, lapack_int const* ldb,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dkygvd(...) LAPACK_dkygvd_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_dkygvd(...) LAPACK_dkygvd_base(__VA_ARGS__)
#endif

#define LAPACK_skygvd_base LAPACK_GLOBAL_SUFFIX(skygvd,SKYGVD)
void LAPACK_skygvd_base(
    lapack_int const* itype, char const* jobz, char const* uplo,
    lapack_int const* n,
    float* A, lapack_int const* lda,
    float* B, lapack_int const* ldb,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_skygvd(...) LAPACK_skygvd_base(__VA_ARGS__, 1, 1)
#else
    #define LAPACK_skygvd(...) LAPACK_skygvd_base(__VA_ARGS__)
#endif
...
#define LAPACK_dkygvx_base LAPACK_GLOBAL_SUFFIX(dkygvx,DKYGVX)
void LAPACK_dkygvx_base(
    lapack_int const* itype, char const* jobz, char const* range, char const* uplo,
    lapack_int const* n,
    double* A, lapack_int const* lda,
    double* B, lapack_int const* ldb,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_dkygvx(...) LAPACK_dkygvx_base(__VA_ARGS__, 1, 1, 1)
#else
    #define LAPACK_dkygvx(...) LAPACK_dkygvx_base(__VA_ARGS__)
#endif

#define LAPACK_skygvx_base LAPACK_GLOBAL_SUFFIX(skygvx,SKYGVX)
void LAPACK_skygvx_base(
    lapack_int const* itype, char const* jobz, char const* range, char const* uplo,
    lapack_int const* n,
    float* A, lapack_int const* lda,
    float* B, lapack_int const* ldb,
...
#ifdef LAPACK_FORTRAN_STRLEN_END
    #define LAPACK_skygvx(...) LAPACK_skygvx_base(__VA_ARGS__, 1, 1, 1)
#else
    #define LAPACK_skygvx(...) LAPACK_skygvx_base(__VA_ARGS__)
#endif
