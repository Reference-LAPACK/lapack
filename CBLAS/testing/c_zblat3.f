...
*     .. External Subroutines ..
      EXTERNAL           ZCHK1, ZCHK2, ZCHK3, ZCHK4,
     $                   ZCHK5, ZCHK6, CZ3CHKE, ZMMCH
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     .. Scalars in Common ..
      INTEGER            INFOT, NOUTC
...
10000 FORMAT( ' ', A13,' PASSED THE COLUMN-MAJOR COMPUTATIONAL TESTS',
 ...
 9994 FORMAT(' ******* FATAL ERROR - ERROR-EXIT TAKEN ON VALID CALL *',
     $      '******' )
 9979 FORMAT( ' ', A13,' COLUMN-MAJOR COMPUTATIONAL TESTS:', I9,
     $      ' RUN,', I9, ' FAILED' )
 9978 FORMAT( ' ', A13,' ROW-MAJOR    COMPUTATIONAL TESTS:', I9,
     $      ' RUN,', I9, ' FAILED' )
*
*     End of ZCHK1.
*
