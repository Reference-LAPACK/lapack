...
*  cblas_dskewsymv  T PUT F FOR NO TEST. SAME COLUMNS.
...
*  cblas_dskewsyr2  T PUT F FOR NO TEST. SAME COLUMNS.
*
*     See:
*
...
*           Test DGEMV, 01, and DGBMV, 02.
  140       IF (CORDER) THEN
     ...
     $                  X, XX, XS, Y, YY, YS, YT, G, 1 )
            END IF
            GO TO 200
*           Test DSYMV, 03, DSBMV, 04, and DSPMV, 05, and DSKEWSYMV, 17.
  150       IF (CORDER) THEN
...
*           Test DSYR, 13, and DSPR, 14.
  180       IF (CORDER) THEN
     ...
     $                  YT, G, Z, 1 )
            END IF
            GO TO 200
*           Test DSYR2, 15, and DSPR2, 16, and DSKEWSYR2, 18.
  190       IF (CORDER) THEN
...
*  =====================================================================
     ...
     $                  XS, Y, YY, YS, YT, G, IORDER )
      IMPLICIT NONE
*
*  Tests DSYMV, DSBMV and DSPMV, DSKEWSYMV.
*
*  Auxiliary routine for test program for Level 2 Blas.
*
*  -- Written on 10-August-1987.
...
*
     ...
     $                           CUPLO, N, ALPHA, LDA, INCX, BETA, INCY
                              IF( REWI )
     $                           REWIND NTRA
                              CALL CDSKEWSYMV( IORDER, UPLO, N, ALPHA,
...
*  =====================================================================
     ...
     $                  Z, IORDER )
      IMPLICIT NONE
*
*  Tests DSYR2 and DSPR2, DSKEWSYR2.
*
*  Auxiliary routine for test program for Level 2 Blas.
*
*  -- Written on 10-August-1987.
...
*     .. External Functions ..
      ...
      EXTERNAL           LDE, LDERES
*     .. External Subroutines ..
      EXTERNAL           DMAKE, DMVCH, CDSPR2, CDSYR2, CDSKEWSYR2
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     .. Scalars in Common ..
      INTEGER            INFOT, NOUTC
...
*
     ...
     $                     ALPHA, INCX, INCY, LDA
                        IF( REWI )
     $                     REWIND NTRA
                        CALL CDSKEWSYR2( IORDER, UPLO, N, ALPHA, XX,
     $                              INCX, YY, INCY, AA, LDA )
                     ELSE IF( PACKED )THEN
                        IF( TRACE )
     $                     WRITE( NTRA, FMT = 9994 )NC, SNAME, CUPLO, N,
