 ...
 *
 * cblas_sskewsyr2k.c
 * This program is a C interface to sskewsyr2k.
...
#include "cblas.h"
#include "cblas_f77.h"
void API_SUFFIX(cblas_sskewsyr2k)(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
                  ...
                  float  *C, const CBLAS_INT ldc)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      F77_sskewsyr2k(F77_UL, F77_TR, &F77_N, &F77_K, &alpha, A, &F77_lda, B, &F77_ldb, &beta, C, &F77_ldc);
   } else if (layout == CblasRowMajor)
   {
      ...
      minus_alpha = -alpha;
      F77_sskewsyr2k(F77_UL, F77_TR, &F77_N, &F77_K, &minus_alpha, A, &F77_lda, B, &F77_ldb, &beta, C, &F77_ldc);
   } else  API_SUFFIX(cblas_xerbla)(1, "cblas_sskewsyr2k",
