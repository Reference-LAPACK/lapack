 ...
 *
 * cblas_dskewsyr2k.c
 * This program is a C interface to dskewsyr2k.
...
#include "cblas.h"
#include "cblas_f77.h"
void API_SUFFIX(cblas_dskewsyr2k)(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
                  ...
                  double  *C, const CBLAS_INT ldc)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      {
         API_SUFFIX(cblas_xerbla)(3, "cblas_dskewsyr2k","Illegal Trans setting, %d\n", Trans);
         CBLAS_CallFromC = 0;
         RowMajorStrg = 0;
         return;
      }
      ...
      F77_dskewsyr2k(F77_UL, F77_TR, &F77_N, &F77_K, &alpha, A, &F77_lda,
   ...
   } else if (layout == CblasRowMajor)
   {
      ...
      minus_alpha = -alpha;
      F77_dskewsyr2k(F77_UL, F77_TR, &F77_N, &F77_K, &minus_alpha, A, &F77_lda, B,
                &F77_ldb, &beta, C, &F77_ldc);
   }
   else API_SUFFIX(cblas_xerbla)(1, "cblas_dskewsyr2k","Illegal layout setting, %d\n", layout);
   CBLAS_CallFromC = 0;
   RowMajorStrg = 0;
   return;
}
