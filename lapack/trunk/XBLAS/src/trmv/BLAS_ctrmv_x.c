  ...
  case blas_prec_single:{
	...
	if (diag == blas_unit_diag) {
	  if (trans == blas_conj_trans) {
		...
		x_elem[1] = x_i[xj + 1];
		{
		  prod[0] = x_elem[0] * t_elem[0] - x_elem[1] * t_elem[1];
		  prod[1] = x_elem[0] * t_elem[1] + x_elem[1] * t_elem[0];
		}
	...
	if (diag == blas_unit_diag) {
	  if (trans == blas_conj_trans) {
		...
		x_elem[1] = x_i[xj + 1];
		{
		  ...
		  double d2;
		  /* Real part */
		  d1 = (double) x_elem[0] * t_elem[0];
		  d2 = (double) -x_elem[1] * t_elem[1];
		  {
		  ...
		  tail_prod[0] = tail_e1;
		  /* imaginary part */
		  d1 = (double) x_elem[0] * t_elem[1];
		  d2 = (double) x_elem[1] * t_elem[0];
		  {
		    /* Compute double-double = double + double. */
		    double e, t1, t2;
