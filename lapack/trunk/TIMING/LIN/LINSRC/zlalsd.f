...
*     .. External Subroutines ..
      EXTERNAL           ZDROT, ZCOPY, ZLACPY,
     $                   ZLALSA, ZLASCL, ZLASET, DGEMM,
     $                   DLARTG, DLASCL, DLASDA, DLASDQ,
     $                   DLASET, DLASRT, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            IDAMAX
...
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DCMPLX, DBLE, DIMAG, ABS, INT, LOG, SIGN
*     ..
