*> \brief \b ZTRSM_LVL2_MOD solves a singular triangular system
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE ZTRSM_LVL2_MOD(SIDE,UPLO,TRANSA,DIAG,M,N,ALPHA,A,LDA,B,LDB)
*
*       .. Scalar Arguments ..
*       COMPLEX*16 ALPHA
*       INTEGER LDA,LDB,M,N
...
*> \verbatim
*>
*> ZTRSM_LVL2_MOD  solves one of the matrix equations
*>
...
*>
*> \verbatim
*> Modified from ztrsm originally written in 1989
...
*>
*  =====================================================================
      SUBROUTINE ZTRSM_LVL2_MOD(SIDE, UPLO, TRANSA, DIAG, M, N,
     $      ALPHA, A, LDA, B, LDB)
      IMPLICIT NONE
*     .. Scalar Arguments ..
      COMPLEX*16 ALPHA
