*> \brief \b DLARFT_UT forms the triangular factor T of a block reflector H = I - vtvH
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DLARFT_UT + dependencies
...
*> \verbatim
*>
*> DLARFT_UT forms the triangular factor T of a real block reflector H
...
*
         CALL DSYRK('Upper', 'Transpose', K, N-K, ONE, V(K+1,1),
     $         LDV, ONE, T, LDT)
*
...
*
         CALL DSYRK('Upper', 'No Transpose', K, N-K, ONE, V(1,K+1),
     $         LDV, ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*
         CALL DSYRK('Lower', 'No Transpose', K, N-K, ONE, V(1,K+1),
     $         LDV, ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*
         CALL DSYRK('Lower', 'Transpose', K, N-K, ONE, V, LDV,
     $         ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*        Compute T = lt(V_2 * V_2**H + T)
*
         CALL DSYRK('Lower', 'No Transpose', K, N-K, ONE, V, LDV,
     $         ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*        Compute T = ut(V_2 * V_2**H + T)
*
         CALL DSYRK('Upper', 'No Transpose', K, N-K, ONE, V, LDV,
     $         ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
