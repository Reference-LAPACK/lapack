...
*  ===========
*
*       SUBROUTINE ZLAQZ0( WANTS, WANTQ, WANTZ, N, ILO, IHI, A, LDA, B, LDB,
...
*              to the top and deflate it
     ...
     $                   S1 )
                  ...
                  IF( K2.LT.ISTOP ) THEN
                     CALL ZLARTG( A( K2, K2 - 1 ), A( K2 + 1, K2 - 1 ),
     $                   C1, S1, TEMP )
                     A( K2, K2 - 1 ) = TEMP
                     A( K2 + 1, K2 - 1 ) = CZERO
...
*
     ...
     $       ALPHA( SHIFTPOS ), BETA( SHIFTPOS ), A, LDA, B, LDB, Q,
     $       LDQ, Z, LDZ, WORK, NBLOCK, WORK( NBLOCK**2 + 1 ), NBLOCK,
