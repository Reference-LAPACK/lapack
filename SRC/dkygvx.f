...
*
*> Download DKYGVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dkygvx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dkygvx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dkygvx.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DKYGVX( ITYPE, JOBZ, RANGE, UPLO, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> DKYGVX computes selected eigenvalues, and optionally, eigenvectors
*> of a real generalized skew-symmetric-definite eigenproblem, of the form
*> A*x=(lambda)*B*x,  A*Bx=(lambda)*x,  or B*A*x=(lambda)*x.  Here A
*> and B are assumed to be skew-symmetric and B is also positive definite.
...
*>
*>          On exit, the strictlylower triangle (if UPLO='L') or the 
...
*>          by reducing C to tridiagonal form, where C is the skew-symmetric
*>          matrix of the standard skew-symmetric problem to which the
...
*>          eigenvalues in block descending order. Refer to SKYGV. 
*> \endverbatim
*>
*> \param[out] Z
*> \verbatim
...
*>          > 0:  DPOTRF or DKYEVX returned an error code:
*>             <= N:  if INFO = i, DKYEVX failed to converge;
...
*     .. External Subroutines ..
      EXTERNAL           DPOTRF, DKYEVX, DKYGST, DTRMM, DTRSM,
     $                   XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
      ...
      CALL DKYEVX( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU,
     $             ABSTOL,
