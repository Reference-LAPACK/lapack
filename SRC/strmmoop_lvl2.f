*> \brief \b STRMMOOP_LVL2 computes an out of place triangular times general matrix multiplication
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*     SUBROUTINE STRMMOOP_LVL2(SIDE, UPLO, TRANSA, TRANSB, DIAG
...
*
               DO I = 1, M
                  CALL STRMVOOP(UPLO, TRANSF, DIAG, N, ALPHA,
