...
*        arguments W and WORK respectively in the call to CLAORHR.
*        WORK in CLAORHR is only used as a work array in the
*        call to CLAMTSQR. Therefore, the optimal size LW2 for
*        WORK in CLAORHR is the same asthe optimal size for WORK
*        in CLAMTSQR.
*
         LDW = M
         LW1 = LDW * N
