*> \brief \b SLAGTSK solves the system of equations (T-λI)x = y
...
*
*> Download SLAGTSK + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slagtsk.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slagtsk.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slagtsk.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SLAGTSK( JOB, N, A, B, C, D, IN, YR, YI, TOL, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, JOB, N
*       REAL               TOL
...
*> \verbatim
*>
*> SLAGTSK may be used to solve one of the systems of equations
*>
...
*> \verbatim
*>          JOB is INTEGER
*>          Specifies the job to be performed by SLAGTSK as follows:
...
*
*  =====================================================================
      SUBROUTINE SLAGTSK( JOB, N, A, B, C, D, IN, YR, YI, TOL,
     $                    INFO )
      IMPLICIT NONE
*
...
*     .. Local Scalars ..
      INTEGER            K
      REAL               ABSAK, AK, BIGNUM, EPS, PERT, SFMIN,
     $                   TEMPR, TEMPI
*     ..
*     .. Intrinsic Functions ..
