...
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/skygst.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/skygst.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/skygst.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
...
*> \verbatim
*>
*>  Derived from subroutine ssygst.
*>
*> \endverbatim
*
*> \par Contributors:
...
*
     ...
     $                           ONE, A( K, K+KB ), LDA )
                     CALL SKYR2K( UPLO, 'Transpose', N-K-KB+1, KB,
     $                            -ONE, A( K, K+KB ), LDA,
     $                            B( K, K+KB ), LDB, ONE,
     $                            A( K+KB, K+KB ), LDA )
                     CALL SKYMM( 'Left', UPLO, KB, N-K-KB+1, -HALF,
...
*
     ...
     $                           ONE, A( K+KB, K ), LDA )
                     CALL SKYR2K( UPLO, 'No transpose', N-K-KB+1,
     $                            KB, ONE, A( K+KB, K ), LDA,
     $                            B( K+KB, K ), LDB, ONE,
     $                            A( K+KB, K+KB ), LDA )
                     CALL SKYMM( 'Right', UPLO, N-K-KB+1, KB, -HALF,
...
*
     ...
     $                        A( 1, K ), LDA )
                  CALL SKYMM( 'Right', UPLO, K-1, KB, HALF,
...
*
     ...
     $                        A( K, 1 ), LDA )
                  CALL SKYMM( 'Left', UPLO, KB, K-1, HALF,
     ...
     $                        A( K, K ), LDA, B( K, 1 ), LDB, ONE,
     $                        A( K, 1 ), LDA )
                  CALL STRMM( 'Left', UPLO, 'Transpose',
