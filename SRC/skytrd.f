...
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/SKYtrd.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/SKYtrd.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/SKYtrd.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
...
*> \verbatim
*>
*>  Derived from subroutine ssytrd.
*>
*> \endverbatim
*
*> \par Contributors:
