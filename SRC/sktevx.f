*> \brief <b> SKTEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download SKTEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sktevx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sktevx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sktevx.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SKTEVX( JOBZ, RANGE, N, E, VL, VU, IL, IU, ABSTOL,
...
*> \verbatim
*>
*> SKTEVX computes selected eigenvalues and, optionally, eigenvectors
...
*
*  =====================================================================
      SUBROUTINE SKTEVX( JOBZ, RANGE, N, E, VL, VU, IL, IU,
     $                   ABSTOL,
     $                   M, W, Z, LDZ, WORK, IWORK, IFAIL, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SSCAL, SKTEBZ, SKTEIN, SKTEQR
     $                   SSWAP, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*     call SKTEQR.  If this fails for some eigenvalue, then
*     try SKTEBZ.
*
      TEST = .FALSE.
      IF( INDEIG ) THEN
...
*      IF( ( ALLEIG .OR. TEST ) .AND. ( ABSTOL.LE.ZERO ) ) THEN
      IF( .FALSE. ) THEN
         CALL SCOPY( N-1, E( 1 ), 1, W, 1 )
         INDWRK = N + 1
         CALL SKTEQR( 'I', N, W, Z, LDZ, WORK( INDWRK ),
     $                INFO )
         IF( INFO.EQ.0 ) THEN
            DO 10 I = 1, N
               IFAIL( I ) = 0
...
*
      ...
      INDISP = 1 + N
      INDIWO = INDISP + N
      CALL SKTEBZ( RANGE, ORDER, N, VLL, VUU, IL, IU, ABSTOL, E,
     $             M,
     $             NSPLIT, W, IWORK( 1 ), IWORK( INDISP ),
     $             WORK( INDWRK ), IWORK( INDIWO ), INFO )
*
      IF( WANTZ ) THEN
         CALL SKTEIN( N, E, M, W, IWORK( 1 ), IWORK( INDISP ),
