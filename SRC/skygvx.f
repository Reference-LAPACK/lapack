...
*
*> Download SKYGVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/skygvx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/skygvx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/skygvx.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SKYGVX( ITYPE, JOBZ, RANGE, UPLO, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> SKYGVX computes selected eigenvalues, and optionally, eigenvectors
...
*>          > 0:  SPOTRF or SKYEVX returned an error code:
*>             <= N:  if INFO = i, SKYEVX failed to converge;
...
*     .. External Subroutines ..
      EXTERNAL           SPOTRF, SKYEVX, SKYGST, STRMM, STRSM,
     $                   XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
      ...
      CALL SKYEVX( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU,
     $             ABSTOL,
