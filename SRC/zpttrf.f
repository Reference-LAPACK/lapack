...
*
      I4 = MOD( N-1, 4 )
      DO 10 I = 1, I4
         IF( D( I ).LE.ZERO.OR.DISNAN( D( I ) ) ) THEN
            INFO = I
            GO TO 30
         END IF
         EIR = DBLE( E( I ) )
...
*
         ...
         D( I+1 ) = D( I+1 ) - F*EIR - G*EII
*
         IF( D( I+1 ).LE.ZERO.OR.DISNAN( D( I+1 ) ) ) THEN
            INFO = I + 1
            GO TO 30
         END IF
*
...
*
         IF( D( I+2 ).LE.ZERO.OR.DISNAN( D( I+2 ) ) ) THEN
            INFO = I + 2
            GO TO 30
         END IF
*
...
*
         IF( D( I+3 ).LE.ZERO.OR.DISNAN( D( I+3 ) ) ) THEN
            INFO = I + 3
            GO TO 30
         END IF
*
