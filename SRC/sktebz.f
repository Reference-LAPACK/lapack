...
*
*> Download SKTEBZ + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sktebz.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sktebz.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sktebz.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SKTEBZ( RANGE, ORDER, N, VL, VU, IL, IU, ABSTOL, E,
...
*> \verbatim
*>
*> SKTEBZ computes the eigenvalues of a skew-symmetric tridiagonal
...
*>          eigenvalues.  (SKTEBZ may use the remaining N-M elements as
*>          workspace.)
*> \endverbatim
*>
*> \param[out] IBLOCK
...
*>          belongs.  (SKTEBZ may use the remaining N-M elements as
*>          workspace.)
*> \endverbatim
*>
*> \param[out] ISPLIT
