...
*>
*>  DIRECT = 'F' and STOREV = 'C':         DIRECT = 'F' and (STOREV = 'R' or STOREV = 'T'):
*>
*>               V = (  1       )                 V = (  1 v1 v1 v1 v1 )
*>                   ( v1  1    )                     (     1 v2 v2 v2 )
*>                   ( v1 v2  1 )                     (        1 v3 v3 )
...
*>                   ( v1 v2 v3 )
*>
*>  DIRECT = 'B' and STOREV = 'C':         (DIRECT = 'B' or DIRECT = 'T') and STOREV = 'R':
*>
...
*
      EXTERNAL          SLARFT_LVL2, STRMM, SGEMM, SLACPY, XERBLA
*
*     .. External Functions..
*
      LOGICAL            LSAME
...
*
         CALL SGEMM('No Transpose', 'Transpose', K-L, L, N-K, ONE, V,
