*> \brief \b STRSM_LVL2_MOD solves a singular triangular system
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE STRSM_LVL2_MOD(SIDE,UPLO,TRANSA,DIAG,M,N,ALPHA,A,LDA,B,LDB)
*
*       .. Scalar Arguments ..
*       REAL ALPHA
*       INTEGER LDA,LDB,M,N
...
*> \verbatim
*>
*> STRSM_LVL2_MOD solves one of the matrix equations
*>
...
*>
*> \verbatim
*> Modified from strsm originally written in 1989
...
*>
*  =====================================================================
      SUBROUTINE STRSM_LVL2_MOD(SIDE, UPLO, TRANSA, DIAG, M, N,
     $      ALPHA, A, LDA, B, LDB)
      IMPLICIT NONE
*     .. Scalar Arguments ..
      REAL ALPHA
