...
*  ===========
*
*       SUBROUTINE ZLARFT_LVL2( DIRECT, STOREV, N, K, V, LDV, TAU, T, LDT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ZLARFT_LVL2 forms the triangular factor T of a real block reflector H
...
*     are essentially unrolling the recursion present in ZLARFT, so
