...
*     .. External Functions ..
      ...
      EXTERNAL           LSAME, DLAMCH, ZLANHE, ILAENV
*     ..
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.LE.1 ) THEN
            ...
            WORK( 1 ) = LWMIN
         ELSE
            KD    = ILAENV( 17, 'ZHETRD_2STAGE', JOBZ,
     $                            N, -1, -1, -1 )
            IB    = ILAENV( 18, 'ZHETRD_2STAGE', JOBZ,
     $                            N, KD, -1, -1 )
            LHTRD = ILAENV( 19, 'ZHETRD_2STAGE', JOBZ,
     $                            N, KD, IB, -1 )
            LWTRD = ILAENV( 20, 'ZHETRD_2STAGE', JOBZ,
     $                            N, KD, IB, -1 )
            LWMIN = N + LHTRD + LWTRD
            WORK( 1 )  = LWMIN
         END IF
