*> \brief \b SLAGTFK computes an LU factorization of a matrix T-λI, where T is a general tridiagonal matrix with purely imaginary diagonal, and λ a purely imaginary scalar, using partial pivoting with row interchanges.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download SLAGTFK + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slagtfk.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slagtfk.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slagtfk.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SLAGTFK( N, A, LAMBDA, B, C, TOL, D, IN, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, N
*       REAL               LAMBDA, TOL
...
*> \verbatim
*>
*> SLAGTFK factorizes the matrix (T - lambda*I), where T is an n by n
...
*>
*> The parameter LAMBDA is included in the routine so that SLAGTFK may
...
*     .. Local Scalars ..
      INTEGER            K, PRMCT
      REAL               EPS, MULT, PIV1, PIV2, SCALE1, SCALE2,
     $                   TEMP, TL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
