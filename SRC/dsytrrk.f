...
*  ===========
*
*     RECURSIVE SUBROUTINE DSYTRRK(UPLOA, UPLOC, TRANS, DIAG, K,
...
*> \verbatim
*>
*> DSYTRRK performs one of the symmetric rank k operations
*>
...
*
      IF(K.LT.NX.OR.K.EQ.1) THEN
         CALL DSYTRRK_LVL2(UPLOA, UPLOC, TRANS, DIAG, K,
     $         ALPHA, A, LDA, BETA, C, LDC)
         RETURN
      END IF
*
...
*
            CALL DSYTRRK(UPLOA, UPLOC, TRANS, DIAG, L, ALPHA,
     $            A, LDA, BETA, C, LDC)
*
*           Compute C_{2,2}
*           C_{2,2} = \alpha*A_{2,2}**H*A_{2,2} + \beta C_{2,2}
*
            CALL DSYTRRK(UPLOA, UPLOC, TRANS, DIAG, K-L, ALPHA,
...
*
            CALL DSYTRRK(UPLOA, UPLOC, TRANS, DIAG, L, ALPHA, A, LDA,
     $            BETA, C, LDC)
*
*           Compute C_{2,2}
*           C_{2,2} = \alpha*A_{2,2}*A_{2,2}**H + \beta*C_{2,2}
