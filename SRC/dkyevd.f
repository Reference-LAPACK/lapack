*> \brief <b> DKYEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DKYEVD + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dkyevd.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dkyevd.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dkyevd.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DKYEVD( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, IWORK,
*                          LIWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          JOBZ, UPLO
...
*> \verbatim
*>
*> DKYEVD computes all eigenvalues and, optionally, eigenvectors of a
*> real skew-symmetric matrix A. If eigenvectors are desired, it uses a
*> divide and conquer algorithm.
*>
*> Because of large use of BLAS of level 3, DKYEVD needs N**2 more
...
*>
*  =====================================================================
      SUBROUTINE DKYEVD( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK,
     $                   IWORK,
     $                   LIWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           DLACPY, DORMTR, DSCAL, DKTEDC,
     $                   DKYTRD, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, SQRT
...
*
*     For eigenvalues only, call DKTEDC.  For eigenvectors, first call
*     DKTEDC to generate the eigenvector matrix, WORK(INDWRK), of the
...
*
     ...
     $   CALL DSCAL(N-1, -ONE, W, 1)
      IF( .NOT.WANTZ ) THEN
         CALL DKTEDC( 'N', N, W, WORK( INDWRK ), N, WORK( INDWK2 ),
     $               LLWRK2, IWORK, LIWORK, INFO )
      ELSE
         CALL DKTEDC( 'I', N, W, WORK( INDWRK ), N, WORK( INDWK2 ),
     $               LLWRK2, IWORK, LIWORK, INFO )
