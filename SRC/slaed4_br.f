*> \brief \b SLAED4_BR used by SSTEBR.
*
*  SLAED4_BR computes one secular root with SLAED4 and exposes a compact
*  representation of the returned high-relative-accuracy DELTA vector.
*  For N > 2, SLAED4's DELTA entries are all relative to either D(I)
...
*
      SUBROUTINE SLAED4_BR( N, I, D, Z, DELTA, RHO, DLAM, ORG,
     $                       TAU, NEAR1, NEAR2, INFO )
*
*     .. Scalar Arguments ..
      INTEGER            I, INFO, N, ORG
      REAL               DLAM, NEAR1, NEAR2, RHO, TAU
*     ..
*     .. Array Arguments ..
      REAL               D( * ), DELTA( * ), Z( * )
*     ..
...
*     .. Parameters ..
      REAL               HALF, ZERO
      PARAMETER          ( HALF = 0.5E0, ZERO = 0.0E0 )
*     ..
*     .. Local Scalars ..
      REAL               MID
*     ..
*     .. External Subroutines ..
      EXTERNAL           SLAED4, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS
*     ..
...
*
      ...
      END IF
*
*     Avoid reconstructing TAU from DLAM-D(ORG).  SLAED4 already
