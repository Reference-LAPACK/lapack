...
*
*> Download DKTEDC + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dktedc.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dktedc.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dktedc.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DKTEDC( COMPZ, N, E, Z, LDZ, WORK, LWORK, IWORK,
*                          LIWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          COMPZ
...
*> \verbatim
*>
*> DKTEDC computes all eigenvalues and, optionally, eigenvectors of a
...
*     .. External Functions ..
      ...
      EXTERNAL           ILAENV, LSAME, DLAMCH, DLANKT
*     ..
*     .. External Subroutines ..
      EXTERNAL           DGEMM, DLACPY, DLAEDK0, DLASCL, DLASET,
     $                   DKTEQR, DSWAP, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
         SMLSIZ = ILAENV( 9, 'DKTEDC', ' ', 0, 0, 0, 0 )
...
*
      ...
      END IF
*
*     If COMPZ = 'N', use DKTEQR to compute the eigenvalues.
*
      IF( ICOMPZ.EQ.0 ) THEN
...
*
         CALL DKTEQR( COMPZ, N, E, Z, LDZ, WORK, INFO )
*
      ELSE
*
...
*
               ...
               ELSE
                  STRTRW = START
               END IF
               CALL DLAEDK0( ICOMPZ, N, M, E( START ),
...
*              Scale back.
*
               CALL DLASCL( 'G', 0, 0, ONE, ORGNRM, M-1, 1,
     $                      E( START ),  M-1, INFO )
*
            ELSE
               IF( ICOMPZ.EQ.1 ) THEN
...
*
     ...
     $                        Z( 1, START ), LDZ )
               ELSE IF( ICOMPZ.EQ.2 ) THEN
                  CALL DKTEQR( 'I', M, E( START ),
     $                         Z( START, START ), LDZ, WORK, INFO )
               ELSE
                  CALL DKTEQR( 'N', M, E( START ),
     $                         Z( START, START ), LDZ, WORK, INFO )
               END IF
               IF( INFO.NE.0 ) THEN
                  GO TO 70
