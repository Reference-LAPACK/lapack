...
*>
*  =====================================================================
      subroutine slaqz0(wantS,wantQ,wantZ,n,ilo,ihi,A,ldA,B,ldB,alphar,
...
*     Arguments
      ...
      real,intent(inout) :: A(ldA,*),B(ldB,*),Q(ldQ,*),Z(ldZ,*),
...
*     Workspace query to slaqz3
      nw = max(nwr,nmin)
      call slaqz3(ilschur,ilq,ilz,n,ilo,ihi,nw,A,ldA,B,ldB,Q,ldQ,Z,ldZ,
...
*        Time for AED
*
         call slaqz3(ilschur,ilq,ilz,n,istart2,istop,nw,A,ldA,B,ldB,Q,
