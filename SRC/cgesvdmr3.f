*> \brief <b> CGESVDMR3 computes the singular value decomposition (SVD) for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download CGESVDMR3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesvdmr3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesvdmr3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesvdmr3.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*     SUBROUTINE CGESVDMR3( JOBU, JOBVT, RANGE, M, N, A, LDA, VL, VU,
...
*> \verbatim
*>
*>  CGESVDMR3 computes the singular value decomposition (SVD) of a complex
...
*>
*>  CGESVDMR3 uses an eigenvalue problem for obtaining the SVD, which
...
*
            CALL SBDSVDMR3( 'U', JOBZ, RNGTGK, N, RWORK( ID ),
     $                      RWORK( IE ), VL, VU, ILTGK, IUTGK, NS, S,
     $                      RWORK( ITGKZ ), N*2, RWORK( ITEMPR ),
     $                      5*MINMN*MINMN+37*MINMN, IWORK, 24*MINMN,
     $                      INFO )
*
...
*
            CALL SBDSVDMR3( 'U', JOBZ, RNGTGK, M, RWORK( ID ),
     $                      RWORK( IE ), VL, VU, ILTGK, IUTGK, NS, S,
...
*           (Workspace: need 2*M*M+14*M)
*
            CALL SBDSVDMR3( 'L', JOBZ, RNGTGK, M, RWORK( ID ),
     $                      RWORK( IE ), VL, VU, ILTGK, IUTGK, NS, S,
     $                      RWORK( ITGKZ ), M*2, RWORK( ITEMPR ),
     $                      5*MINMN*MINMN+37*MINMN, IWORK, 24*MINMN,
     $                      INFO )
