...
*  ===========
*
*       SUBROUTINE CGEMCV(TRANS,M,N,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
*
*       .. Scalar Arguments ..
*       COMPLEX ALPHA,BETA
...
*> \verbatim
*>
*> CGEMCV  performs one of the matrix-vector operations
*>
