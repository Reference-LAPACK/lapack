...
*        arguments W and WORK respectively in the call to ZLAORHR.
*        WORK in ZLAORHR is only used as a work array in the
*        call to ZLAMTSQR. Therefore, the optimal size LW2 for
*        WORK in ZLAORHR is the same asthe optimal size for WORK
*        in ZLAMTSQR.
*
         LDW = M
         LW1 = LDW * N
