...
*
*> \htmlonly
*> Download ZORHR + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zorhr.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zorhr.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zorhr.f">
*> [TXT]</a>
*>
*  Definition:
*  ===========
*
*       SUBROUTINE ZORHR( M, N, MB1, NB1, A, LDA, T1, LDT1, NB2, T2,
...
*> \verbatim
*>
*> ZORHR performs Householder reconstruction from the orthogonal
...
*> ZLATSQR. The reconstructed orthogonal M-by-M matrix Q_out is
...
*> in A and T from the QR factorization routine ZGEQRT. ZORHR is
*> a high-level routine that uses a single one-dimensional work array
*> WORK of dimension LWORK. ZORHR tests the input parameters, allocates
*> workspace and calls the auxiliary low-level routine ZLAORHR to do
...
*     .. External Subroutines ..
      EXTERNAL           ZLAMTSQR, ZLAORHR, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DCMPLX, INT, MAX, MIN
*     ..
...
*        and determine allocation space for work arrays in ZLAORHR.
*
...
*           in ZLAORHR, and query the optimal size of the work array
*           WORK(LWORK) in ZLAORHR, WORK in ZLAORHR is only used
*           to call ZLAMTSQR from ZLAORHR.
*
            LDW = M
            LW1 = LDW*N
            CALL ZLAMTSQR( 'L', 'N', M, N, N, MB1, NB1LOCAL,
...
*
      ...
      END IF
*
      CALL ZLAORHR( M, N, MB1, NB1LOCAL, A, LDA, T1, LDT1,
