...
*> \verbatim
*>
*> CLAUUM_RECURSIVE computes the product U * U**H or L**H * L, where the triangular
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, CLAUU2, CHERK, CTRMM
*     ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL XERBLA( 'CLAUUM_RECURSIVE', -INFO )
         RETURN
      END IF
*
...
*
      NX = ILAENV(3, "CLAUUM_RECURSIVE", UPLO, N, -1, -1, -1)
      IF( N.LT.NX ) THEN
