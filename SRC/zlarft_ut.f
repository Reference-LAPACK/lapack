*> \brief \b ZLARFT_UT forms the triangular factor T of a block reflector H = I - vtvH
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download ZLARFT_UT + dependencies
...
*  ===========
*
*       SUBROUTINE ZLARFT_UT( DIRECT, STOREV, N, K, V, LDV, TAU, T, LDT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ZLARFT_UT forms the triangular factor T of a complex block reflector H
...
*>
*  =====================================================================
      SUBROUTINE ZLARFT_UT( DIRECT, STOREV, JOBT, N, K, V, LDV, TAU,
     $            T, LDT )
*
...
*
         CALL ZHERK('Upper', 'Conjugate', K, N-K, ONE, V(K+1,1),
     $         LDV, ONE, T, LDT)
*
...
*
         CALL ZHERK('Upper', 'No Transpose', K, N-K, ONE, V(1,K+1),
     $         LDV, ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*
         CALL ZHERK('Lower', 'No Transpose', K, N-K, ONE, V(1,K+1),
     $         LDV, ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*
         CALL ZHERK('Lower', 'Conjugate', K, N-K, ONE, V, LDV,
     $         ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*        Compute T = lt(V_2 * V_2**H + T)
*
         CALL ZHERK('Lower', 'No Transpose', K, N-K, ONE, V, LDV,
     $         ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
...
*        Compute T = ut(V_2 * V_2**H + T)
*
         CALL ZHERK('Upper', 'No Transpose', K, N-K, ONE, V, LDV,
     $         ONE, T, LDT)
*
*        Set the diagonals to 1/tau since we first construct T^{-1}
*           Note: we ensured all of these values are non-zero above
