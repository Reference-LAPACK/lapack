...
*
               ...
               OPS = OPS + DOPLA( 'ZGEQRF', M, N, 0, 0, NB )
...
*              (RWorkspace: need N)
*
               NB = ILAENV( 1, 'ZGEBRD', ' ', N, N, -1, -1 )
               OPS = OPS + DOPLA( 'ZGEBRD', N, N, 0, 0, NB )
...
*              (RWorkspace: 0)
*
               NB = ILAENV( 1, 'ZUNGQR', ' ', M, N, N, -1 )
               OPS = OPS + DOPLA( 'ZUNGQR', M, N, N, 0, NB )
...
*
     ...
     $                      LDWRKU )
               NB = ILAENV( 1, 'ZUNMBR', 'QLN', N, N, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'QLN', N, N, N, 0, NB )
...
*
               ...
               NB = ILAENV( 1, 'ZUNMBR', 'PRC', N, N, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'PRC', N, N, N, 0, NB )
...
*
               DO 10 I = 1, M, LDWRKR
                  ...
                  OPS = OPS + DOPBL3( 'ZGEMM ', CHUNK, N, N )
...
*              (RWorkspace: 0)
*
               NB = ILAENV( 1, 'ZUNGQR', ' ', M, M, N, -1 )
               OPS = OPS + DOPLA( 'ZUNGQR', M, M, N, 0, NB )
...
*
               CALL ZLACP2( 'F', N, N, RWORK( IRVT ), N, VT, LDVT )
               NB = ILAENV( 1, 'ZUNMBR', 'PRT', N, N, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'PRT', N, N, N, 0, NB )
...
*
               ...
               OPS = OPS + DOPLA( 'ZGEBRD', M, N, 0, 0, NB )
...
*
               ...
               OPS = OPS + DOPLA2( 'ZUNGBR', 'P', N, N, N, 0, NB )
...
*              (RWorkspace: 0)
*
               NB = ILAENV( 1, 'ZUNGBR', 'Q', N, N, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNGBR', 'Q', N, N, N, 0, NB )
...
*
               CALL ZLACPY( 'L', M, N, A, LDA, U, LDU )
               NB = ILAENV( 1, 'ZUNGBR', 'Q', M, N, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNGBR', 'Q', M, N, N, 0, NB )
...
*
               CALL ZLACPY( 'L', M, N, A, LDA, U, LDU )
               NB = ILAENV( 1, 'ZUNGBR', 'Q', M, M, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNGBR', 'Q', M, M, N, 0, NB )
...
*
     ...
     $                         LDWRKU )
                  CALL ZLACP2( 'F', N, N, RWORK( IRU ), N, WORK( IU ),
     $                         LDWRKU )
                  NB = ILAENV( 1, 'ZUNMBR', 'QLN', M, N, N, -1 )
                  OPS = OPS + DOPLA2( 'ZUNMBR', 'QLN', M, N, N, 0, NB )
...
*
               CALL ZLACP2( 'F', N, N, RWORK( IRU ), N, U, LDU )
               NB = ILAENV( 1, 'ZUNMBR', 'QLN', M, M, N, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'QLN', M, M, N, 0, NB )
...
*
               ...
               OPS = OPS + DOPLA( 'ZGELQF', M, N, 0, 0, NB )
...
*
               ...
               OPS = OPS + DOPLA( 'ZGEBRD', M, M, 0, 0, NB )
...
*              (RWorkspace: 0)
*
               NB = ILAENV( 1, 'ZUNGLQ', ' ', M, N, M, -1 )
               OPS = OPS + DOPLA( 'ZUNGLQ', M, N, M, 0, NB )
...
*
               ...
               NB = ILAENV( 1, 'ZUNMBR', 'QLN', M, M, M, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'QLN', M, M, M, 0, NB )
...
*
     ...
     $                      LDWKVT )
               NB = ILAENV( 1, 'ZUNMBR', 'PRC', M, M, M, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'PRC', M, M, M, 0, NB )
...
*              (RWorkspace: 0)
*
               NB = ILAENV( 1, 'ZUNGLQ', ' ', N, N, M, -1 )
               OPS = OPS + DOPLA( 'ZUNGLQ', N, N, M, 0, NB )
...
*
               ...
               OPS = OPS + DOPLA2( 'ZUNGBR', 'P', M, N, M, 0, NB )
...
*
               CALL ZLACPY( 'U', M, N, A, LDA, VT, LDVT )
               NB = ILAENV( 1, 'ZUNGBR', 'P', N, N, M, -1 )
               OPS = OPS + DOPLA2( 'ZUNGBR', 'P', N, N, M, 0, NB )
...
*
                  CALL ZLACP2( 'F', M, M, RWORK( IRVT ), M, WORK( IVT ),
     $                         LDWKVT )
                  NB = ILAENV( 1, 'ZUNMBR', 'PRC', M, N, M, -1 )
                  OPS = OPS + DOPLA2( 'ZUNMBR', 'PRC', M, N, M, 0, NB )
...
*
               ...
               CALL ZLACP2( 'F', M, M, RWORK( IRVT ), M, VT, LDVT )
               NB = ILAENV( 1, 'ZUNMBR', 'PRC', N, N, M, -1 )
               OPS = OPS + DOPLA2( 'ZUNMBR', 'PRC', N, N, M, 0, NB )
