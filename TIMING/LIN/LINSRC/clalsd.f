...
*     .. External Subroutines ..
      EXTERNAL           CSROT, CCOPY, CLACPY,
     $                   CLALSA, CLASCL, CLASET, SGEMM,
     $                   SLARTG, SLASCL, SLASDA, SLASDQ,
     $                   SLASET, SLASRT, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ISAMAX
...
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          CMPLX, REAL, AIMAG, ABS, INT, LOG, SIGN
*     ..
