...
*  ===========
*
*       SUBROUTINE SSKEWSYR2K(UPLO,TRANS,N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
*
*       .. Scalar Arguments ..
*       REAL ALPHA,BETA
...
*> \verbatim
*>
*> SSKEWSYR2K performs one of the skew-symmetric rank 2k operations
*>
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYR2K(UPLO,TRANS,N,K,ALPHA,A,LDA,B,
     +                      LDB,BETA,C,LDC)
      IMPLICIT NONE
*
