...
*  ===========
*
*       SUBROUTINE SSKEWSYMM(SIDE,UPLO,M,N,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
*
*       .. Scalar Arguments ..
*       REAL ALPHA,BETA
...
*> \verbatim
*>
*> SSKEWSYMM performs one of the matrix-matrix operations
*>
*>    C := alpha*A*B + beta*C,
*>
*> or
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYMM(SIDE,UPLO,M,N,ALPHA,A,LDA,B,
     +                     LDB,BETA,C,LDC)
      IMPLICIT NONE
*
