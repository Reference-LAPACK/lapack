!> \brief \b ZROTC applies a chain of rotation sequences to a matrix.
!
!  =========== DOCUMENTATION ===========
!
...
!  ===========
!
!   subroutine zrotc(side, dir, startup, shutdown, m, n, k,&
!                    A, lda, C, ldc, S, lds)
!    .. Scalar Arguments ..
...
!> \verbatim
!>
!> ZROTC applies a chain of k rotation sequences of length n to a matrix A.
!>
...
!> \param[in,out] S
!> \verbatim
!>          S is DOUBLE COMPLEX array, dimension (lds,k)
