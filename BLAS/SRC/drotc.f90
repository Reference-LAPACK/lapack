!> \brief \b DROTC applies a chain of rotation sequences to a matrix.
!
!  =========== DOCUMENTATION ===========
!
...
!> \verbatim
!>
!> DROTC applies a chain of k rotation sequences of length n to a matrix A.
!>
