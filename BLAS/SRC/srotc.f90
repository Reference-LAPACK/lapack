!> \brief \b SROTC applies a chain of rotation sequences to a matrix.
!
!  =========== DOCUMENTATION ===========
!
...
!  ===========
!
!   subroutine srotc(side, dir, startup, shutdown, m, n, k,&
!                    A, lda, C, ldc, S, lds)
!    .. Scalar Arguments ..
...
!> \verbatim
!>
!> SROTC applies a chain of k rotation sequences of length n to a matrix A.
!>
