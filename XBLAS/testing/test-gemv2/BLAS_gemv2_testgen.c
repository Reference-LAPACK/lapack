 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_sdot2_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_ddot2_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
		       alpha_flag, beta, beta_flag, head_x, tail_x, temp,
		       seed, &y_elem, &r_true_l[i * incy],
		       &r_true_t[i * incy]);
    y_i[i * incy] = y_elem;
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_cdot2_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
		       alpha_flag, beta, beta_flag, head_x, tail_x, temp,
		       seed, y_elem, &r_true_l[i * incy],
		       &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
		       alpha_flag, beta, beta_flag, head_x, tail_x, temp,
		       seed, y_elem, &r_true_l[i * incy],
		       &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_cdot2_s_s_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_cdot2_c_s_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_cdot2_s_c_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_d_d_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_z_d_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_d_z_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_ddot2_s_s_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, &y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem;
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_ddot2_d_s_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, &y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem;
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_ddot2_s_d_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, &y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem;
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_c_c_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_z_c_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
 ...
 */
{
  ...
  for (i = 0; i < m_i; i++) {
    ...
    BLAS_zdot2_c_z_testgen(n_i, n_fix2, n_mix, norm, blas_no_conj, alpha,
			   alpha_flag, beta, beta_flag, head_x, tail_x, temp,
			   seed, y_elem, &r_true_l[i * incy],
			   &r_true_t[i * incy]);
    y_i[i * incy] = y_elem[0];
