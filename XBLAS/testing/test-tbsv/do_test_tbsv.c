 ...
 */
{
  ...
  x = (double *) blas_malloc(n * 4 * sizeof(double));
  if (n * 4 > 0 && x == NULL) {
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			continue;
		      ...
		      for (row = 0; row < n; row++) {
			BLAS_dtbsv_s_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtbsv_s */

double do_test_ztbsv_c(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
  ...
  /* get space for calculation */
  x = (double *) blas_malloc(n * 4 * sizeof(double) * 2);
  if (n * 4 > 0 && x == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			continue;
		      ...
		      for (row = 0; row < n; row++) {
			BLAS_ztbsv_c_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  for (j = 0; j < n; j++) {
			    if (j == row) {
			      ...
			      /* copy row j of T to temp */
			      ctbsv_copy(order_type, uplo_type, trans_type, n,
					 k, T, ldt, temp, j);
			      ...
			      temp[(row * incT) + 1] = 0.0;
			      /* in doing this we rely that temp[row*incT] == 1.0 */
			      test_BLAS_zdot_z_c(n, blas_no_conj, minus_one,
						 alpha, &x_gen[j * incx_gen],
						 &x[ix],
						 &head_r_true[j * incx_gen],
						 &tail_r_true[j * incx_gen],
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztbsv_c */

double do_test_ctbsv_s(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
  ...
  /* get space for calculation */
  x = (float *) blas_malloc(n * 4 * sizeof(float) * 2);
  if (n * 4 > 0 && x == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			continue;
		      ...
		      for (row = 0; row < n; row++) {
			BLAS_ctbsv_s_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  /* call BLAS_ctbsv_s */
			  FPU_FIX_STOP;
			  BLAS_ctbsv_s(order_type, uplo_type, trans_type,
				       diag_type, n, k, alpha, T, ldt, x,
				       incx_unadj);
			  FPU_FIX_START;
			  test_count++;
			  ...
			  for (j = 0; j < n; j++) {
			    if (j == row) {
			      ...
			      temp[(row * incT)] = 0.0;
			      /* in doing this we rely that temp[row*incT] == 1.0 */
			      test_BLAS_cdot_c_s(n, blas_no_conj, minus_one,
						 alpha, &x_gen[j * incx_gen],
						 &x[ix],
						 &head_r_true[j * incx_gen],
						 &tail_r_true[j * incx_gen],
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctbsv_s */

double do_test_ztbsv_d(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			continue;
		      ...
		      for (row = 0; row < n; row++) {
			BLAS_ztbsv_d_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  for (j = 0; j < n; j++) {
			    if (j == row) {
			      double minus_one[2] = { -1.0, 0.0 };
			      /* copy row j of T to temp */
			      dtbsv_copy(order_type, uplo_type, trans_type, n,
					 k, T, ldt, temp, j);

			      /* zero out the row element, not included in the dot product */
			      temp[(row * incT)] = 0.0;
			      /* in doing this we rely that temp[row*incT] == 1.0 */
			      test_BLAS_zdot_z_d(n, blas_no_conj, minus_one,
						 alpha, &x_gen[j * incx_gen],
						 &x[ix],
						 &head_r_true[j * incx_gen],
						 &tail_r_true[j * incx_gen],
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztbsv_d */

double do_test_stbsv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
  ...
  /* get space for calculation */
  x = (float *) blas_malloc(n * 4 * sizeof(float));
  if (n * 4 > 0 && x == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
	  ...
	  for (order_val = 0; order_val < 2; order_val++) {
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			for (row = 0; row < n; row++) {
			  BLAS_stbsv_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			  ...
			  for (incx_val = -2; incx_val <= 2; incx_val++) {
				...
				int minus_one = -1.0;
				/* copy row j of T to temp */
				stbsv_copy(order_type, uplo_type, trans_type,
					   n, k, T, ldt, temp, j);

				/* zero out the row element, not included in the dot product */
				temp[(row * incT)] = 0.0;
				/* in doing this we rely that temp[row*incT] == 1.0 */
				test_BLAS_sdot(n, blas_no_conj, minus_one,
					       alpha, x_gen[j * incx_gen],
					       x[ix],
					       head_r_true[j * incx_gen],
					       tail_r_true[j * incx_gen], x,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_stbsv_x */

double do_test_dtbsv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
	  ...
	  for (order_val = 0; order_val < 2; order_val++) {
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			for (row = 0; row < n; row++) {
			  BLAS_dtbsv_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			  ...
			  for (incx_val = -2; incx_val <= 2; incx_val++) {
				...
				int minus_one = -1.0;
				/* copy row j of T to temp */
				dtbsv_copy(order_type, uplo_type, trans_type,
					   n, k, T, ldt, temp, j);

				/* zero out the row element, not included in the dot product */
				temp[(row * incT)] = 0.0;
				/* in doing this we rely that temp[row*incT] == 1.0 */
				test_BLAS_ddot(n, blas_no_conj, minus_one,
					       alpha, x_gen[j * incx_gen],
					       x[ix],
					       head_r_true[j * incx_gen],
					       tail_r_true[j * incx_gen], x,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtbsv_x */

double do_test_dtbsv_s_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_dtbsv_s_x";
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtbsv_s_x */

double do_test_ctbsv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
	  ...
	  for (order_val = 0; order_val < 2; order_val++) {
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			for (row = 0; row < n; row++) {
			  BLAS_ctbsv_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			  ...
			  for (incx_val = -2; incx_val <= 2; incx_val++) {
			    ...
			    /* call BLAS_ctbsv_x */
			    FPU_FIX_STOP;
			    BLAS_ctbsv_x(order_type, uplo_type, trans_type,
					 diag_type, n, k, alpha, T, ldt, x,
					 incx_unadj, prec);
			    FPU_FIX_START;
			    test_count++;
				...
				float minus_one[2] = { -1.0, 0.0 };
				/* copy row j of T to temp */
				ctbsv_copy(order_type, uplo_type, trans_type,
					   n, k, T, ldt, temp, j);
				...
				temp[(row * incT) + 1] = 0.0;
				/* in doing this we rely that temp[row*incT] == 1.0 */
				test_BLAS_cdot(n, blas_no_conj, minus_one,
					       alpha, &x_gen[j * incx_gen],
					       &x[ix],
					       &head_r_true[j * incx_gen],
					       &tail_r_true[j * incx_gen], x,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctbsv_x */

double do_test_ztbsv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
	  ...
	  for (order_val = 0; order_val < 2; order_val++) {
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			for (row = 0; row < n; row++) {
			  BLAS_ztbsv_testgen(norm, order_type, uplo_type,
					     trans_type, diag_type, n, k,
					     0 /*randomize */ ,
					     &alpha, alpha_flag, T, ldt,
					     x_gen, seed, head_r_true,
			  ...
			  for (incx_val = -2; incx_val <= 2; incx_val++) {
				...
				double minus_one[2] = { -1.0, 0.0 };
				/* copy row j of T to temp */
				ztbsv_copy(order_type, uplo_type, trans_type,
					   n, k, T, ldt, temp, j);
				...
				temp[(row * incT) + 1] = 0.0;
				/* in doing this we rely that temp[row*incT] == 1.0 */
				test_BLAS_zdot(n, blas_no_conj, minus_one,
					       alpha, &x_gen[j * incx_gen],
					       &x[ix],
					       &head_r_true[j * incx_gen],
					       &tail_r_true[j * incx_gen], x,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztbsv_x */

double do_test_ztbsv_c_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_ztbsv_c_x";
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztbsv_c_x */

double do_test_ctbsv_s_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_ctbsv_s_x";
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			for (row = 0; row < n; row++) {
			  ...
			  for (incx_val = -2; incx_val <= 2; incx_val++) {
			    ...
			    /* call BLAS_ctbsv_s_x */
			    FPU_FIX_STOP;
			    BLAS_ctbsv_s_x(order_type, uplo_type, trans_type,
					   diag_type, n, k, alpha, T, ldt, x,
					   incx_unadj, prec);
			    FPU_FIX_START;
			    test_count++;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctbsv_s_x */

double do_test_ztbsv_d_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_ztbsv_d_x";
...
int main(int argc, char **argv)
{
  ...
  if (argc != 6) {
    printf("Usage:\n");
    printf("do_test_tbsv <nsizes> <ntests> <thresh> <debug> <test_prob>\n");
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing tbsv", 0, 0, NULL);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtbsv_s(n, ntests, &seed, thresh, debug,
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztbsv_c(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctbsv_s(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztbsv_d(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_stbsv_x(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtbsv_x(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtbsv_s_x(n, ntests, &seed, thresh, debug,
					test_prob, &total_min_ratio,
					&num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctbsv_x(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztbsv_x(n, ntests, &seed, thresh, debug,
				      test_prob, &total_min_ratio,
				      &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztbsv_c_x(n, ntests, &seed, thresh, debug,
					test_prob, &total_min_ratio,
					&num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctbsv_s_x(n, ntests, &seed, thresh, debug,
					test_prob, &total_min_ratio,
					&num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztbsv_d_x(n, ntests, &seed, thresh, debug,
					test_prob, &total_min_ratio,
					&num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
