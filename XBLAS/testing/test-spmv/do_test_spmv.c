		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_dspmv_d_s";
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_dspmv_s_s";
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_z_c";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (incy_val = INCY_START; incy_val <= INCY_END; incy_val++) {
		  ...
		  for (randomize_val = RANDOMIZE_START;
		    ...
		    for (i = 0, yi = y_starti, ri = 0;
			 i < n_i; i++, yi += incyi, ri += incri) {
		      zspmv_copy_row(order_type, uplo_type, n_i, a, a_vec, i);
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_c_z";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (incy_val = INCY_START; incy_val <= INCY_END; incy_val++) {
		  ...
		  for (randomize_val = RANDOMIZE_START;
		    ...
		    for (i = 0, yi = y_starti, ri = 0;
			 i < n_i; i++, yi += incyi, ri += incri) {
		      cspmv_copy_row(order_type, uplo_type, n_i, a, a_vec, i);
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_c_c";
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_cspmv_c_s";
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_cspmv_s_s";
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_z_d";
		       ...
		       int *num_bad_ratio, int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_d_d";
		...
		for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
		  ...
		  for (incy_val = INCY_START; incy_val <= INCY_END;
			...
			y_starti = 0;
		      ...
		      for (i = 0, yi = y_starti, ri = 0;
			   i < n_i; i++, yi += incyi, ri += incri) {
			cspmv_copy_row(order_type, uplo_type,
				       n_i, a, a_vec, i);
		...
		for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
		  ...
		  for (incy_val = INCY_START; incy_val <= INCY_END;
			...
			y_starti = 0;
		      ...
		      for (i = 0, yi = y_starti, ri = 0;
			   i < n_i; i++, yi += incyi, ri += incri) {
			zspmv_copy_row(order_type, uplo_type,
				       n_i, a, a_vec, i);
...
void do_test_zspmv_z_c_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_z_c_x";
...
void do_test_zspmv_c_z_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_c_z_x";
...
void do_test_zspmv_c_c_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_c_c_x";
...
void do_test_cspmv_c_s_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_cspmv_c_s_x";
...
void do_test_cspmv_s_s_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_cspmv_s_s_x";
...
void do_test_zspmv_z_d_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_z_d_x";
...
void do_test_zspmv_d_d_x(int n,
			 int ntests, int *seed, double thresh, int debug,
			 float test_prob, double *min_ratio,
			 double *max_ratio, int *num_bad_ratio,
			 int *num_tests)
{
  ...
  /* Function name */
  const char fname[] = "BLAS_zspmv_d_d_x";
...
int main(int argc, char **argv)
{
  ...
  if (argc != 6) {
    printf("Usage:\n");
    printf("do_test_spmv <nsizes> <ntests> <thresh> <debug> <test_prob>\n");
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing spmv", 0, 0, NULL);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dspmv_s_s(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_z_c(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_c_z(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_c_c(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_cspmv_s_s(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_d_d(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_sspmv_x(n, ntests, &seed, thresh, debug,
		    test_prob, &min_ratio, &max_ratio,
		    &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dspmv_x(n, ntests, &seed, thresh, debug,
		    test_prob, &min_ratio, &max_ratio,
		    &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dspmv_d_s_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_z_c_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_c_z_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_c_c_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_cspmv_s_s_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zspmv_d_d_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
