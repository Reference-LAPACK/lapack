 ...
 */
{
  ...
  float *tp;
  double *x;
  double *x_gen;		/* used to store vectors generated by testgen; eventually copied to x */
  ...
  x = (double *) blas_malloc(3 * n * 2 * sizeof(double));
  if (3 * n * 2 > 0 && x == NULL) {
	  ...
	  for (uplo_val = 0; uplo_val < 2; uplo_val++) {
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
		    ...
		    /* copy x_gen to x */
		    for (j = 0; j < n; j++) {
		      x[ix] = x_gen[j * inc_index];
		      ix += incx;
		    }

		    /* call BLAS_dtpmv_s */
		    FPU_FIX_STOP;
		    BLAS_dtpmv_s(order_type, uplo_type, trans_type, diag_type,
		    ...
		    for (j = 0; j < n; j++) {
		      ...
		      stpmv_copy_row(order_type, uplo_type, trans_type, n, tp,
				     temp, j);
		      ...
		      test_BLAS_ddot_s_d(n, blas_no_conj,
					 ...
					 tail_r_true[j * inc_index], temp, 1,
			...
			for (j = 0; j < n; j++) {
			  /* copy row j of tp to temp */
			  stpmv_copy_row(order_type, uplo_type, trans_type, n,
					 tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtpmv_s */

double do_test_ztpmv_c(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
  ...
  /* get space for calculation */
  x = (double *) blas_malloc(3 * n * 2 * sizeof(double) * 2);
  if (3 * n * 2 > 0 && x == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
	  ...
	  for (uplo_val = 0; uplo_val < 2; uplo_val++) {
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
		    ...
		    for (j = 0; j < n; j++) {
		      /* copy row j of tp to temp */
		      ctpmv_copy_row(order_type, uplo_type, trans_type, n, tp,
				     temp, j);
			...
			for (j = 0; j < n; j++) {
			  /* copy row j of tp to temp */
			  ctpmv_copy_row(order_type, uplo_type, trans_type, n,
					 tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztpmv_c */

double do_test_ctpmv_s(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
  ...
  float *tp;
  float *x;
  float *x_gen;			/* used to store vectors generated by testgen; eventually copied to x */
  float *temp;			/* use for calculating ratio */
  ...
  /* get space for calculation */
  x = (float *) blas_malloc(3 * n * 2 * sizeof(float) * 2);
  if (3 * n * 2 > 0 && x == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
	  ...
	  for (uplo_val = 0; uplo_val < 2; uplo_val++) {
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
		    ...
		    /* call BLAS_ctpmv_s */
		    FPU_FIX_STOP;
		    BLAS_ctpmv_s(order_type, uplo_type, trans_type, diag_type,
				 n, alpha, tp, x, incx_val);
		    FPU_FIX_START;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctpmv_s */

double do_test_ztpmv_d(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
	  ...
	  for (uplo_val = 0; uplo_val < 2; uplo_val++) {
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
		    ...
		    for (j = 0; j < n; j++) {
		      /* copy row j of tp to temp */
		      dtpmv_copy_row(order_type, uplo_type, trans_type, n, tp,
				     temp, j);
			...
			for (j = 0; j < n; j++) {
			  /* copy row j of tp to temp */
			  dtpmv_copy_row(order_type, uplo_type, trans_type, n,
					 tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztpmv_d */

double do_test_stpmv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
  ...
  /* get space for calculation */
  x = (float *) blas_malloc(3 * n * 2 * sizeof(float));
  if (3 * n * 2 > 0 && x == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			test_BLAS_sdot(n, blas_no_conj,
				       ...
				       head_r_true[j * inc_index],
				       tail_r_true[j * inc_index], temp, 1,
				       x_gen, 1, eps_int, un_int, &ratios[j]);
			...
			if ((debug == 3) &&	/* print only when debug is on */
			  ...
			  for (j = 0; j < n; j++) {
			    /* copy row j of tp to temp */
			    stpmv_copy_row(order_type, uplo_type, trans_type,
					   n, tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_stpmv_x */

double do_test_dtpmv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			ix += incx;
		      ...
		      /* call BLAS_dtpmv_x */
		      FPU_FIX_STOP;
		      BLAS_dtpmv_x(order_type, uplo_type, trans_type,
				   diag_type, n, alpha, tp, x, incx_val,
				   prec);
		      FPU_FIX_START;
			...
			if ((debug == 3) &&	/* print only when debug is on */
			  ...
			  for (j = 0; j < n; j++) {
			    /* copy row j of tp to temp */
			    dtpmv_copy_row(order_type, uplo_type, trans_type,
					   n, tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtpmv_x */

double do_test_ctpmv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			ix += incx;
		      ...
		      /* call BLAS_ctpmv_x */
		      FPU_FIX_STOP;
		      BLAS_ctpmv_x(order_type, uplo_type, trans_type,
				   diag_type, n, alpha, tp, x, incx_val,
				   prec);
		      FPU_FIX_START;
			...
			if ((debug == 3) &&	/* print only when debug is on */
			  ...
			  for (j = 0; j < n; j++) {
			    /* copy row j of tp to temp */
			    ctpmv_copy_row(order_type, uplo_type, trans_type,
					   n, tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctpmv_x */

double do_test_ztpmv_x(int n,
		       int ntests,
		       int *seed,
		       double thresh,
		       int debug,
 ...
 */
{
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			ix = -(n - 1) * incx;
		      ...
		      for (j = 0; j < n; j++) {
			/* copy row j of tp to temp */
			ztpmv_copy_row(order_type, uplo_type, trans_type, n,
				       tp, temp, j);
			...
			if ((debug == 3) &&	/* print only when debug is on */
			  ...
			  for (j = 0; j < n; j++) {
			    /* copy row j of tp to temp */
			    ztpmv_copy_row(order_type, uplo_type, trans_type,
					   n, tp, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztpmv_x */

double do_test_dtpmv_s_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_dtpmv_s_x";
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			ix += incx;
		      ...
		      /* call BLAS_dtpmv_s_x */
		      FPU_FIX_STOP;
		      BLAS_dtpmv_s_x(order_type, uplo_type, trans_type,
				     diag_type, n, alpha, tp, x, incx_val,
				     prec);
		      FPU_FIX_START;
			...
			test_BLAS_ddot_s_d(n, blas_no_conj,
					   alpha, beta_zero_fake,
					   rin_zero_fake, x[ix],
					   head_r_true[j * inc_index],
					   tail_r_true[j * inc_index], temp,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtpmv_s_x */

double do_test_ztpmv_c_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_ztpmv_c_x";
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ztpmv_c_x */

double do_test_ctpmv_s_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_ctpmv_s_x";
		...
		for (diag_val = 0; diag_val < 2; diag_val++) {
		  ...
		  for (i = 0; i < ntests; i++) {
			...
			ix += incx;
		      ...
		      /* call BLAS_ctpmv_s_x */
		      FPU_FIX_STOP;
		      BLAS_ctpmv_s_x(order_type, uplo_type, trans_type,
				     diag_type, n, alpha, tp, x, incx_val,
				     prec);
		      FPU_FIX_START;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctpmv_s_x */

double do_test_ztpmv_d_x(int n,
			 int ntests,
			 int *seed,
			 double thresh,
			 int debug,
...
{
  /* function name */
  const char fname[] = "BLAS_ztpmv_d_x";
...
int main(int argc, char **argv)
{
  ...
  if (argc != 6) {
    printf("Usage:\n");
    printf("do_test_tpmv <nsizes> <ntests> <thresh> <debug> <test_prob>\n");
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing tpmv", 0, 0, NULL);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtpmv_s(n, ntests, &seed, thresh, debug,
				      test_prob,
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztpmv_c(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctpmv_s(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztpmv_d(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_stpmv_x(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtpmv_x(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctpmv_x(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztpmv_x(n, ntests, &seed, thresh, debug,
				      test_prob,
				      &total_min_ratio, &num_bad_ratio,
				      &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtpmv_s_x(n, ntests, &seed, thresh, debug,
					test_prob,
					&total_min_ratio, &num_bad_ratio,
					&num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztpmv_c_x(n, ntests, &seed, thresh, debug,
					test_prob,
					&total_min_ratio, &num_bad_ratio,
					&num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctpmv_s_x(n, ntests, &seed, thresh, debug,
					test_prob,
					&total_min_ratio, &num_bad_ratio,
					&num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztpmv_d_x(n, ntests, &seed, thresh, debug,
					test_prob,
					&total_min_ratio, &num_bad_ratio,
					&num_tests);
    if (total_max_ratio > max_ratio)
