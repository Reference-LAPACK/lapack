...
void do_test_dsbmv_d_s
  ...
  /* Function name */
  const char fname[] = "BLAS_dsbmv_d_s";
  ...
  *max_ratio = 0.0;
  ...
  y = (double *) blas_malloc(6 * n_i * sizeof(double));
  if (6 * n_i > 0 && y == NULL) {
  ...
  a = (double *) blas_malloc(2 * n_i * n_i * 8 * sizeof(double));
  ...
  ratios = (double *) blas_malloc(2 * n_i * sizeof(double));
  if (2 * n_i > 0 && ratios == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			BLAS_dsbmv_d_s_testgen(norm, order_type,
			...
			for (i = 0, yi = y_starti, ri = 0;
			  ...
			  dsbmv_copy_row(order_type, uplo_type,
					 n_i, a, k, lda, a_vec, i);
...
void do_test_dsbmv_s_d
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dsbmv_s_d";
  ...
  *max_ratio = 0.0;
  ...
  a = (float *) blas_malloc(2 * n_i * n_i * 8 * sizeof(float));
  if (2 * n_i * n_i * 8 > 0 && a == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_dsbmv_s_d_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
			...
			for (i = 0, yi = y_starti, ri = 0;
			     i < n_i; i++, yi += incyi, ri += incri) {
			  ssbmv_copy_row(order_type, uplo_type,
					 n_i, a, k, lda, a_vec, i);
...
void do_test_dsbmv_s_s
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dsbmv_s_s";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_dsbmv_s_s_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_zsbmv_z_c
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_z_c";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_zsbmv_z_c_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
			...
			for (i = 0, yi = y_starti, ri = 0;
			     i < n_i; i++, yi += incyi, ri += incri) {
			  zsbmv_copy_row(order_type, uplo_type,
					 n_i, a, k, lda, a_vec, i);
...
void do_test_zsbmv_c_z
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_c_z";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_zsbmv_c_z_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
			...
			for (i = 0, yi = y_starti, ri = 0;
			     i < n_i; i++, yi += incyi, ri += incri) {
			  csbmv_copy_row(order_type, uplo_type,
					 n_i, a, k, lda, a_vec, i);
...
void do_test_zsbmv_c_c
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_c_c";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_zsbmv_c_c_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_csbmv_c_s
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_c_s";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_csbmv_c_s_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_csbmv_s_c
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_s_c";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_csbmv_s_c_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_csbmv_s_s
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_s_s";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_csbmv_s_s_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_zsbmv_z_d
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_z_d";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_zsbmv_z_d_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_zsbmv_d_z
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_d_z";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_zsbmv_d_z_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_zsbmv_d_d
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_d_d";
	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			/* finally we are here to generate the test case */
			BLAS_zsbmv_d_d_testgen(norm, order_type,
					       uplo_type, n, randomize_val,
					       &alpha, alpha_flag, &beta,
					       beta_flag, a, k, lda, x, incx,
					       y, incy, seed, head_r_true,
...
void do_test_ssbmv_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_ssbmv_x";
  ...
  *max_ratio = 0.0;
  ...
  /* allocate memory for arrays */
  y = (float *) blas_malloc(6 * n_i * sizeof(float));
  if (6 * n_i > 0 && y == NULL) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
		...
		for (k = 0; k < n_i; k++) {
		  ...
		  for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
			...
			for (randomize_val = RANDOMIZE_START;
			  ...
			  /* finally we are here to generate the test case */
			  BLAS_ssbmv_testgen(norm, order_type,
					     uplo_type, n, randomize_val,
					     &alpha, alpha_flag, &beta,
...
void do_test_dsbmv_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dsbmv_x";
		...
		for (k = 0; k < n_i; k++) {
		  ...
		  for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
			...
			for (randomize_val = RANDOMIZE_START;
			  ...
			  /* finally we are here to generate the test case */
			  BLAS_dsbmv_testgen(norm, order_type,
					     uplo_type, n, randomize_val,
					     &alpha, alpha_flag, &beta,
					     beta_flag, a, k, lda, x, incx, y,
					     incy, seed, head_r_true,
...
void do_test_csbmv_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_x";
		...
		for (k = 0; k < n_i; k++) {
		  ...
		  for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
			...
			for (randomize_val = RANDOMIZE_START;
			  ...
			  /* finally we are here to generate the test case */
			  BLAS_csbmv_testgen(norm, order_type,
					     uplo_type, n, randomize_val,
					     &alpha, alpha_flag, &beta,
					     beta_flag, a, k, lda, x, incx, y,
					     incy, seed, head_r_true,
...
void do_test_zsbmv_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_x";
		...
		for (k = 0; k < n_i; k++) {
		  ...
		  for (lda_val = LDA_START; lda_val <= LDA_END; lda_val++) {
			...
			for (randomize_val = RANDOMIZE_START;
			  ...
			  /* finally we are here to generate the test case */
			  BLAS_zsbmv_testgen(norm, order_type,
					     uplo_type, n, randomize_val,
					     &alpha, alpha_flag, &beta,
					     beta_flag, a, k, lda, x, incx, y,
					     incy, seed, head_r_true,
...
void do_test_dsbmv_d_s_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dsbmv_d_s_x";
...
void do_test_dsbmv_s_d_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dsbmv_s_d_x";
...
void do_test_dsbmv_s_s_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dsbmv_s_s_x";
...
void do_test_zsbmv_z_c_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_z_c_x";
...
void do_test_zsbmv_c_z_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_c_z_x";
...
void do_test_zsbmv_c_c_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_c_c_x";
...
void do_test_csbmv_c_s_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_c_s_x";
...
void do_test_csbmv_s_c_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_s_c_x";
...
void do_test_csbmv_s_s_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_csbmv_s_s_x";
...
void do_test_zsbmv_z_d_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_z_d_x";
...
void do_test_zsbmv_d_z_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_d_z_x";
...
void do_test_zsbmv_d_d_x
  (int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zsbmv_d_d_x";
...
int main(int argc, char **argv)
{
  ...
  if (argc != 6) {
    printf("Usage:\n");
    printf("do_test_sbmv <nsizes> <ntests> <thresh> <debug> <test_prob>\n");
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing sbmv", 0, 0, NULL);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_d_s(n, ntests, &seed, thresh, debug,
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_s_d(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_s_s(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_z_c(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_c_z(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_c_c(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_c_s(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_s_c(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_s_s(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_z_d(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_d_z(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_d_d(n, ntests, &seed, thresh, debug,
		      test_prob, &min_ratio, &max_ratio,
		      &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_ssbmv_x(n, ntests, &seed, thresh, debug,
		    test_prob, &min_ratio, &max_ratio,
		    &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_x(n, ntests, &seed, thresh, debug,
		    test_prob, &min_ratio, &max_ratio,
		    &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_x(n, ntests, &seed, thresh, debug,
		    test_prob, &min_ratio, &max_ratio,
		    &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_x(n, ntests, &seed, thresh, debug,
		    test_prob, &min_ratio, &max_ratio,
		    &num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_d_s_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_s_d_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_dsbmv_s_s_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_z_c_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_c_z_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_c_c_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_c_s_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_s_c_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_csbmv_s_s_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_z_d_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_d_z_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    do_test_zsbmv_d_d_x(n, ntests, &seed, thresh, debug,
			test_prob, &min_ratio, &max_ratio,
			&num_bad_ratio, &num_tests);
