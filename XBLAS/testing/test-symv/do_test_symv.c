	  ...
	  for (order_val = ORDER_START; order_val <= ORDER_END; order_val++) {
		...
		for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
		  ...
		  for (incy_val = INCY_START; incy_val <= INCY_END;
			...
			dsy_copy_row(order_type, uplo_type,
				     n_i, a, lda, a_vec, i);
		...
		for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
		  ...
		  for (incy_val = INCY_START; incy_val <= INCY_END;
			...
			y_starti = 0;
		      ...
		      for (i = 0, yi = y_starti, ri = 0;
			   i < n_i; i++, yi += incyi, ri += incri) {
			ssy_copy_row(order_type, uplo_type,
				     n_i, a, lda, a_vec, i);
		...
		for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
		  ...
		  for (incy_val = INCY_START; incy_val <= INCY_END;
			...
			y_starti = 0;
		      ...
		      for (i = 0, yi = y_starti, ri = 0;
			   i < n_i; i++, yi += incyi, ri += incri) {
			zsy_copy_row(order_type, uplo_type,
				     n_i, a, lda, a_vec, i);
		...
		for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
		  ...
		  for (incy_val = INCY_START; incy_val <= INCY_END;
			...
			y_starti = 0;
		      ...
		      for (i = 0, yi = y_starti, ri = 0;
			   i < n_i; i++, yi += incyi, ri += incri) {
			csy_copy_row(order_type, uplo_type,
				     n_i, a, lda, a_vec, i);
