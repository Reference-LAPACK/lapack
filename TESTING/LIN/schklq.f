...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, SERRLQ, SGELQF, SGELS,
     $                   SGET02, SLACPY, SLARHS, SLATB4, SLATMS, SLQT01,
     $                   SLQT02, SLQT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
     ...
     $            A( 1 ) = ( ONE - QUARTER )*SLAMCH( 'Overflow' )
*
