...
*  ===========
*
*       SUBROUTINE DKYT01_AA( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV, C, LDC,
*                             RWORK, RESID )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DKYT01_AA reconstructs a skew-symmetric indefinite matrix A from its
...
*
*  =====================================================================
      SUBROUTINE DKYT01_AA( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV, C,
     $                         LDC, RWORK, RESID )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
...
*
     ...
     $                   LDC+1 )
            CALL DSCAL(N-1, -ONE, C( 2, 1 ), LDC+1)
         ELSE
            CALL DLACPY( 'F', 1, N-1, AFAC( 2, 1 ), LDAFAC+1, C( 1, 2 ),
     $                   LDC+1 )
            CALL DSCAL(N-1, -ONE, C( 1, 2 ), LDC+1)
