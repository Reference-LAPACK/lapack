...
*  ===========
*
*       SUBROUTINE SDRVKY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*> \verbatim
*>
*> SDRVKY_AA tests the driver routine SKYSV_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE SDRVKY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR,
...
*
*                    Factor the matrix and solve the system using SKYSV_AA.
*
                     SRNAMT = 'SKYSV_AA'
                     CALL SKYSV_AA( UPLO, N, NRHS, AFAC, LDA, IWORK,
...
*
  ...
  100                   CONTINUE
                     ...
                     END IF
*
*                    Check error code from SKYSV_AA .
*
                     IF( INFO.NE.K ) THEN
                        CALL ALAERH( PATH, 'SKYSV_AA ', INFO, K,
     $                               UPLO, N, N, -1, -1, NRHS,
...
*                    residual.
*
                     CALL SKYT01_AA( UPLO, N, A, LDA, AFAC, LDA,
