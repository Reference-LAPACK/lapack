...
*> \verbatim
*>
*> ZCHKORHR tests ZORHR using ZLATSQR and ZGEMQRT. Therefore, ZLATSQR
...
*     .. External Subroutines ..
      EXTERNAL           ALAHD, ALASUM, ZERRORHR, ZORHR01
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      IF( TSTERR ) CALL ZERRORHR( PATH, NOUT )
      INFOT = 0
*
