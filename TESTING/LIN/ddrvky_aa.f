...
*  ===========
*
*       SUBROUTINE DDRVKY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*> \verbatim
*>
*> DDRVKY_AA tests the driver routine DKYSV_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE DDRVKY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR,
...
*     .. External Subroutines ..
     ...
     $                   DKYSV_AA, DKYT01_AA, DKYTRF_AA, XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*32       SRNAMT
...
*
*                    Factor the matrix and solve the system using DKYSV_AA.
*
                     SRNAMT = 'DKYSV_AA'
                     CALL DKYSV_AA( UPLO, N, NRHS, AFAC, LDA, IWORK,
...
*
  ...
  100                   CONTINUE
                     ...
                     END IF
*
*                    Check error code from DKYSV_AA .
*
                     IF( INFO.NE.K ) THEN
                        CALL ALAERH( PATH, 'DKYSV_AA ', INFO, K,
     $                               UPLO, N, N, -1, -1, NRHS,
...
*                    residual.
*
                     CALL DKYT01_AA( UPLO, N, A, LDA, AFAC, LDA,
