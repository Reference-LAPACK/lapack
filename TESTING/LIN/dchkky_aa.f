...
*  ===========
*
*       SUBROUTINE DCHKKY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> DCHKKY_AA tests DKYTRF_AA, -TRS_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, DERRKY, DLACPY, DLARHS,
     $                   DLATB4, DLATMS, DPOT07, DKYT01_AA, DKYTRF_AA,
     $                   DKYTRS_AA, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                  SRNAMT = 'DKYTRF_AA'
                  LWORK = MAX( 1, N*NB + N )
                  CALL DKYTRF_AA( UPLO, N, AFAC, LDA, IWORK, AINV,
     $                            LWORK, INFO )
*
...
*
                  IF( INFO.NE.K ) THEN
                     CALL ALAERH( PATH, 'DKYTRF_AA', INFO, K, UPLO,
...
*
                  CALL DKYT01_AA( UPLO, N, A, LDA, AFAC, LDA, IWORK,
...
*
                  IF( INFO.NE.0 .OR. MOD(N, 2).NE.0 ) THEN
                     GO TO 140
                  END IF
*
...
*
                     SRNAMT = 'DKYTRS_AA'
                     LWORK = MAX( 1, 3*N-2 )
                     CALL DKYTRS_AA( UPLO, N, NRHS, AFAC, LDA,
...
*
                     IF( INFO.NE.0 ) THEN
                        IF( IZERO.EQ.0 ) THEN
                           CALL ALAERH( PATH, 'DKYTRS_AA', INFO, 0,
...
*
                        CALL DPOT07( UPLO, N, NRHS, A, LDA, X, LDA,
