...
*  ===========
*
*       SUBROUTINE SCHKKY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> SCHKKY_AA tests SKYTRF_AA, -TRS_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, SERRKY, SLACPY, SLARHS,
     $                   SLATB4, SLATMS, SPOT07, SKYT01_AA, SKYTRF_AA,
     $                   SKYTRS_AA, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC    MAX, MIN
...
*
                  SRNAMT = 'SKYTRF_AA'
                  LWORK = MAX( 1, N*NB + N )
                  CALL SKYTRF_AA( UPLO, N, AFAC, LDA, IWORK, AINV,
     $                            LWORK, INFO )
*
...
*
                  IF( INFO.NE.K ) THEN
                     CALL ALAERH( PATH, 'SKYTRF_AA', INFO, K, UPLO,
...
*
                  CALL SKYT01_AA( UPLO, N, A, LDA, AFAC, LDA, IWORK,
...
*
                     SRNAMT = 'SKYTRS_AA'
                     LWORK = MAX( 1, 3*N-2 )
                     CALL SKYTRS_AA( UPLO, N, NRHS, AFAC, LDA,
...
*
                     IF( INFO.NE.0 ) THEN
                        IF( IZERO.EQ.0 ) THEN
                           CALL ALAERH( PATH, 'SKYTRS_AA', INFO, 0,
...
*
                        CALL SPOT07( UPLO, N, NRHS, A, LDA, X, LDA,
