...
*
*
*     CSTEMR must return for a tridiagonal matrix that contains a NaN
...
*
     ...
     $    ILAENV( 10, 'CSTEMR', 'VA', 1, 0, 0, 0 ).EQ.1 .AND.
     $    ILAENV( 11, 'CSTEMR', 'VA', 1, 0, 0, 0 ).EQ.1 ) THEN
         N = NMAX
         RONE = ONE
         RNAN = SQRT( -RONE )
  ...
  320       CONTINUE
            ...
            IU = 0
            TRYRAC = .TRUE.
            CALL CSTEMR( JOBZ, 'A', N, SD, SE, VL, VU, IL, IU, M,
...
*
      ...
      RETURN
*
 9986 FORMAT( ' CCHKST: CSTEMR( ', A1, ', A ) on a matrix with a',
