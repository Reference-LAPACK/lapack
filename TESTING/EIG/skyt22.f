...
*  ===========
*
*       SUBROUTINE SKYT22( ITYPE, UPLO, N, M, KBAND, A, LDA, D, E, U, LDU,
...
*> \verbatim
*>
*>      SKYT22  generally checks a decomposition of the form
*>
*>              A U = U S
*>
*>      where A is skew-symmetric, the columns of U are orthonormal, and S
*>      is diagonal (if KBAND=0) or skew-symmetric tridiagonal (if
...
*>
*>  N       INTEGER
*>          The size of the matrix.  If it is zero, SKYT22 does nothing.
*>          It must be at least zero.
*>          Not modified.
*>
*>  M       INTEGER
*>          The number of columns of U.  If it is zero, SKYT22 does
...
*     .. External Functions ..
      REAL               SLAMCH, SLANKY
      EXTERNAL           SLAMCH, SLANKY
*     ..
*     .. External Subroutines ..
      EXTERNAL           SGEMM, SKYMM
*     ..
*     .. Intrinsic Functions ..
...
*     Norm of A:
*
      ANORM = MAX( SLANKY( '1', UPLO, N, A, LDA, WORK ), UNFL )
*
*     Compute error matrix:
*
*     ITYPE=1: error = U**T A U - S
*
      CALL SKYMM( 'L', UPLO, N, M, ONE, A, LDA, U, LDU, ZERO, WORK, N )
      NN = N*N
      NNP1 = NN + 1
   ...
   20    CONTINUE
      END IF
      WNORM = SLANKY( '1', UPLO, M, WORK( NNP1 ), N, WORK( 1 ) )
*
