...
*  ===========
*
*       SUBROUTINE DKYT22( ITYPE, UPLO, N, M, KBAND, A, LDA, D, E, U, LDU,
...
*> \verbatim
*>
*>      DKYT22  generally checks a decomposition of the form
*>
*>              A U = U S
*>
...
*>
*>  N       INTEGER
*>          The size of the matrix.  If it is zero, DKYT22 does nothing.
*>          It must be at least zero.
*>          Not modified.
*>
*>  M       INTEGER
*>          The number of columns of U.  If it is zero, DKYT22 does
...
*     .. External Functions ..
      ...
      EXTERNAL           DLAMCH, DLANKY
*     ..
*     .. External Subroutines ..
      EXTERNAL           DGEMM, DKYMM
*     ..
*     .. Intrinsic Functions ..
...
*     Norm of A:
*
      ANORM = MAX( DLANKY( '1', UPLO, N, A, LDA, WORK ), UNFL )
*
*     Compute error matrix:
*
*     ITYPE=1: error = U**T A U - S
*
      CALL DKYMM( 'L', UPLO, N, M, ONE, A, LDA, U, LDU, ZERO, WORK, N )
      NN = N*N
      NNP1 = NN + 1
   ...
   20    CONTINUE
      END IF
      WNORM = DLANKY( '1', UPLO, M, WORK( NNP1 ), N, WORK( 1 ) )
*
