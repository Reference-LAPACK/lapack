...
*  ===========
*
*       SUBROUTINE DKTT22( N, M, KBAND, AD, AE, SD, SE, U, LDU, WORK,
*                          LDWORK, RESULT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DKTT22  checks a set of M eigenvalues and eigenvectors,
*>
*>     A U = U S
*>
...
*> \verbatim
*>          N is INTEGER
*>          The size of the matrix.  If it is zero, DKTT22 does nothing.
...
*> \verbatim
*>          M is INTEGER
*>          The number of eigenpairs to check.  If it is zero, DKTT22
...
*
   ...
   40 CONTINUE
*
      WNORM = DLANKY( '1', 'L', M, WORK, M, WORK( 1, M+1 ) )
*
