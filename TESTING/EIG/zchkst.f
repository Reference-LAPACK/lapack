...
*
*
*     ZSTEMR must return for a tridiagonal matrix that contains a NaN
...
*     call returns at all.
*
      IF( NMAX.GE.3 .AND. LRWORK.GE.18*NMAX .AND.
     $    LIWORK.GE.12*NMAX .AND.
...
*
      ...
      RETURN
*
 9986 FORMAT( ' ZCHKST: ZSTEMR( ', A1, ', A ) on a matrix with a',
